...
module SwaggerClient
  class OpenApiControllerWebMvcApi
    ...
    def get_documentation_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OpenApiControllerWebMvcApi.get_documentation ...'
      end
      # resource path
      local_var_path = '/v3/api-docs'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OpenApiControllerWebMvcApi#get_documentation\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
